...
#
# Created: Fri Dec 18 16:51:36 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.g1FeedXYLineEdit, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.zFinalMillDepthLineEdit, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.zInitialMillDepthLineEdit, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.zInfeedDepthLineEdit, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.g1FeedZLineEdit, 10, 1, 1, 1)
        ...
        self.toolOffsetSideEdit = QtGui.QComboBox(self.millSettingsFrame)
        self.toolOffsetSideEdit.setObjectName(_fromUtf8("toolOffsetSideEdit"))
        self.toolOffsetSideEdit.addItem(_fromUtf8(""))
        self.toolOffsetSideEdit.addItem(_fromUtf8(""))
        self.toolOffsetSideEdit.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.toolOffsetSideEdit, 11, 1, 1, 1)
        ...
        self.label = QtGui.QLabel(self.millSettingsFrame)
        self.label.setObjectName(_fromUtf8("label"))
        self.horizontalLayout_15.addWidget(self.label)
        self.gridLayout.addLayout(self.horizontalLayout_15, 11, 0, 1, 1)
        self.horizontalLayout_23 = QtGui.QHBoxLayout()
        self.horizontalLayout_23.setObjectName(_fromUtf8("horizontalLayout_23"))
        self.label_2 = QtGui.QLabel(self.millSettingsFrame)
        ...
        self.horizontalLayout_23.addWidget(self.unitlabel_10)
        self.gridLayout.addLayout(self.horizontalLayout_23, 0, 0, 1, 1)
        self.toolOffsetRadiusEdit = QtGui.QLineEdit(self.millSettingsFrame)
        self.toolOffsetRadiusEdit.setObjectName(_fromUtf8("toolOffsetRadiusEdit"))
        self.gridLayout.addWidget(self.toolOffsetRadiusEdit, 0, 1, 1, 1)
        ...
        MainWindow.setTabOrder(self.canvas, self.layersShapesTreeView)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolOffsetSideEdit.setItemText(0, QtGui.QApplication.translate("MainWindow", "None", None, QtGui.QApplication.UnicodeUTF8))
        self.toolOffsetSideEdit.setItemText(1, QtGui.QApplication.translate("MainWindow", "Left", None, QtGui.QApplication.UnicodeUTF8))
        self.toolOffsetSideEdit.setItemText(2, QtGui.QApplication.translate("MainWindow", "Right", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label.setText(QtGui.QApplication.translate("MainWindow", "Tool Offset Side", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("MainWindow", "Tool Offset Radius", None, QtGui.QApplication.UnicodeUTF8))
        self.unitlabel_10.setText(QtGui.QApplication.translate("MainWindow", "[mm]", None, QtGui.QApplication.UnicodeUTF8))
